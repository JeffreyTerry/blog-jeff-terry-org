...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      main: {
        expand: true,
        cwd: 'assets/',
        src: ['js/**', 'imgs/**', 'sounds/**', 'posts/**', 'fonts/**', 'styles/fonts.css', 'styles/external_libs/**'],
        dest: 'public/',
      },
      js: {
        expand: true,
  ...
  grunt.registerTask('build', ['clean', 'uglify', 'sass', 'cssmin', 'svgmin', 'imagemin', 'copy:pdfs', 'copy:ico', 'copy:css', 'copy:fonts', 'copy:posts', 'copy:sounds', 'copy:external_css', 'copy:external_js']);
};